...
\section{Синтез алгоритмов управления} \label{ch:ch4/synthesis}

\subsection{Синтез алгоритмов управления и моделирование программного устройства} \label{ch:ch4/sect2+}
...
\subsection{Синтез, моделирование возмущений} \label{ch:ch4/sect2+1}
...
\section{Моделирование и исследование динамики с учетом нелинейностей регулятора} \label{subsec:ch4/modeling}
...
\subsection{Моделирование и исследование динамики изолированных каналов управления ОЭП в режимах наведения и стабилизации} \label{ch:ch4/sect6}
...
\begin{figure}[ht]
	\centering
	\includegraphics[width=1.0\linewidth]{non-linear_az} 
...
На рисунках \ref{fig:az31} - \ref{fig:az33} приведены переходные и установившиеся процессы стабилизации ОЭП относительно заданного направления при действии указанных выше возмущений и нелинейностей (\ref{eq:p4:425+}). При этом коэффициенты датчика и усилителя должны быть не менее $K_{\textit{д1}} K_{\textit{к1}} K_{\textit{у1}} = 1000$ В/рад.

Исходные данные для модели:

\begingroup
\captiondelim{ } % разделитель идентификатора с номером от наименования
\lstinputlisting[caption={Исходные данные для КИМ5 (канал азимута)},label={lst:az_nl}]{listings/az_nl.m}
\endgroup
...
\begin{enumerate}
	...
	\begin{figure}[ht]
		\centering
		\includegraphics[width=1.0\linewidth]{az_8_v6} 
	...
	\begin{figure}[ht]
		\centering
		\includegraphics[width=1.0\linewidth]{az_8_v12} 
	...
	\begin{figure}[ht]
		\centering
		\includegraphics[width=1.0\linewidth]{az_8_v3} 
...
\begingroup
\captiondelim{ } % разделитель идентификатора с номером от наименования
\lstinputlisting[caption={Исходные данные для КИМ6 (канал угла места)},label={lst:um_nl}]{listings/um_nl.m}
\endgroup
...
\begin{enumerate}
	...
	\begin{figure}[ht]
		\centering
		\includegraphics[width=1.0\linewidth]{um_8_v3} 
		\caption{Процессы стабилизации ОЭП при входных воздействиях  вариант 6}
		\label{fig:um35}
	\end{figure}
	...
	\begin{figure}[ht]
		\centering
		\includegraphics[width=1.0\linewidth]{um_8_v12} 
		\caption{Процессы стабилизации ОЭП при входных воздействиях  вариант 1 и 2}
		\label{fig:um36}
	\end{figure}
	...
	\begin{figure}[ht]
		\centering
		\includegraphics[width=1.0\linewidth]{um_8_v4} 
...
На основе проведенных исследований динамики изолированных каналов управления ЦСАУ определены требования к параметрам элементов регулятора и объекта управления из условий обеспечения точности управления, устойчивости и качества переходного процесса.
